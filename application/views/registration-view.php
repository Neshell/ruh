<div class="container">
    <div class="row">
        <div class="main-view__outer сol-12">
            <div class="col-12 col-sm-6 col-md-4 col-xl">
                <div class="about_us_desc">
                    <img class="about_us_img img-fluid" src="/img/head%201.png" alt="head">
                    <p class="text-justify-center text-light ">Проект руханка був створений для дітей віком від 6 до 17
                        років.
                        Через карантин діти почали набагато меньше рухатися, тому ми і розробили цей додаток, щоб
                        школярі та
                        могли проводити невиличку фізкульт хвилинку у вільній від навчання час
            ...
            <div class="col-12 col-sm-6 col-md-4 col-xl">
                <form method="post" action="registration/stepRegistration">
                    ...
                    <div class="form-group">
                        <input name="email" type="email" class="form-control" placeholder="Введіть вашу пошту"
                               id="exampleInputEmail1"
                               aria-describedby="emailHelp">
                    </div>
                    <div class="form-group">
                        <input name="password" type="password" placeholder="Вигадайте пароль"
                               class="password form-control"
                               id="exampleInputPassword">
                        <input type="checkbox" onclick="myFunction(this.id)" id="checkbox1">Показати пароль
                    </div>
                    <div class="form-group">
                        <input name="twoPassword" type="password" placeholder="Повторіть пароль "
                               class="password form-control"
